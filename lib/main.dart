...
//                         }
//                       },
//                       child: Text(Localization.getTranslation('confirm', Get.locale?.languageCode ?? 'ar')),
//                       style: ElevatedButton.styleFrom(
//                         padding: EdgeInsets.symmetric(vertical: 14),
//                         shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
//                       ),
...
//                     },
//                     child: Text(themeController.isDarkMode.value ? 'تغيير إلى الوضع النهاري' : 'تغيير إلى الوضع الليلي'),
//                     style: ElevatedButton.styleFrom(
//                       padding: EdgeInsets.symmetric(vertical: 14),
//                       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)),
//                     ),
